...
const slides = [
        ...
        content: `
            <div class="sign">
                <div class="information">
                    <div class="patient">
                        <p><strong>Ф.И.О. Пациента:</strong><br> <span class="text-block">Пациент А.</span></p>
                    ...
                    <p class="text-block">G71.0 — Прогрессирующая мышечная дистрофия Дюшенна (дупликация экзона 19-го гена DMD в гемизиготном состоянии).</p>
                    <p><strong>Сопутствующие заболевания:</strong></p>
                    <p class="text-block">I42.9 — Кардиопатия неуточненная у ребенка с ПМД Дюшенна (умеренная дилатация полости ЛЖ). Эквиновальгусная деформация стоп. Дизартрия. Сложная дислалия.</p>
    ...
    },
    {
        ...
        questionData: {
            ...
            answers: [
                { id: 1, text: "Пол пациента (мужской), установленный диагноз «прогрессирующая миодистрофия» у родственников мужского пола по материнской линии или неуточненное нервно-мышечное заболевание, дебют клинических проявлений в возрасте 2–5 лет.", value: "correct-answer-value" },
                { id: 2, text: "Пол пациента (женский), установленный диагноз «прогрессирующая миодистрофия» у родственников мужского пола по материнской линии или неуточненное нервно-мышечное заболевание, дебют клинических проявлений в возрасте 2–5 лет.", value: "wrong-answer-value" },
                { id: 3, text: "Пол пациента (мужской), установленный диагноз «прогрессирующая миодистрофия» у родственников мужского пола по материнской линии или неуточненное нервно-мышечное заболевание, дебют клинических проявлений в возрасте 7–10 лет.", value: "wrong-answer-value" }
            ],
            correctDescription: "Мужской пол пациента, диагноз «прогрессирующая миодистрофия» у родственников мужского пола по материнской линии или неуточненное нервно-мышечное заболевание и дебют клинических проявлений в возрасте 2–5 лет указывает на мышечную дистрофию Дюшенна <sup>1</sup>.",
            wrongDescription: "Правильный ответ: пол пациента (мужской), установленный диагноз «прогрессирующая миодистрофия» у родственников мужского пола по материнской линии или неуточненное нервно-мышечное заболевание, дебют клинических проявлений в возрасте 2–5 лет. <br><br>Эти анамнестические данные указывают на мышечную дистрофию Дюшенна <sup>1</sup>.",
            additionalInfo: {
...

    {
        ...
        questionData: {
            id: 4,
            text: "Что необходимо уточнить у родителей/опекунов пациента для полноценного сбора анамнеза при подозрении на МДД?",
            answers: [
                { id: 1, text: "Наблюдается ли у ребенка повышенная утомляемость (снижение выносливости)?", value: "wrong-answer-value" },
                { id: 2, text: "Есть ли у ребенка сложности при выполнении физических упражнений (приседания, бег или преодоление препятствий), неспособность прыгать?", value: "wrong-answer-value" },
            ...
            correctDescription: "Для полноценного сбора анамнеза при подозрении на МДД у родителей необходимо получить ответы на все эти вопросы <sup>1</sup>:<br><br> 1. Наблюдается ли у ребенка повышенная утомляемость (снижение выносливости)?<br> 2. Есть ли у ребенка сложности при выполнении физических упражнений (приседания, бег или преодоление препятствий), неспособность прыгать?<br> 3. Были ли у ребенка задержка речевого развития или нарушения артикуляции?",
    ...
    },
    {
        ...
        questionData: {
            ...
            answers: [
                ...
                { id: 3, text: "Готическое небо со скученностью зубов, высокое и «тонкое» тело с длинными конечностями, арахнодактилией и деформацией грудной клетки, атрофические кожные стрии.", value: "another-wrong-answer-value" },
    ...
    },
    {
        ...
        content: `
            <div class="sign">
                ...
                <hr class="dashed-line">
                <p class="text-block-child">07.01.2023 с тошнотой, рвотой, бледностью кожных покровов поступил в отделение токсикологии, где были выявлены неоднократные повышения трансаминаз и КФК (до 11070 Ед/л), проводилась дезинтоксиканционная, гепатопротекторная терапия. Учитывая отсутствие снижения трансаминаз и КФК в динамике, у ребенка было заподозрено нервно-мышечное заболевание.</p>
                <button id="nextButton">Далее</button>
            </div>
        `,
        nextSlide: 7 
    ...
    },
    {
        ...
        <div class="patient-child">
            ...
            <p class="text-block-child">
                ...
                Поиск делеций и дупликаций в гене DMD методом MLPA - дупликация экзона 19-го<br>
    ...
    },
    {
        ...
        questionData: {
            ...
            correctDescription: `
                Дифференциальную диагностику МДД проводят со следующими заболеваниями <sup>1</sup>:<br><br>
                • Воспалительная миопатия.<br>
                • Врожденные миопатии.<br>
                • Метаболические миопатии.<br>
                • Болезни мотонейронов.<br>
                • Болезни нервно-мышечной передачи.<br>
    ...
    },
    {
        ...
        <div class="patient-child">
            ...
            <p class="text-block-baby">Состояние пациента: средней тяжести. Сознание: ясное. Ребенок: контактен. Положение: активное. Вес/масса тела: 23 кг. Индекс массы тела: 17,85. Рост/длина: 113,5 см (перцентиль 50-75 %). Физическое развитие: дисгармоничное за счет избытка массы. Мышечная система развита: удовлетворительно. Тонус мышц: нормальный. Форма грудной клетки: правильная. Костные деформации: нет. Деформация нижних конечностей: вальгусная деформация стоп, плоскостопие. Частота дыхания: 20 в мин. Одышка: утомляемость. Принимает стероиды ежедневно. Психическое развитие: соответствует возрасту, гиперактивность. Психоневрологическое состояние по основному заболеванию: больной в сознании, в контакт вступает, эмоциональный, обращенную речь понимает, команды выполняет. Отмечается гиперактивность. Речь – развернутая фраза, дизартрия. Повороты головы в полном объеме. Поднимание плеч не затруднено. Язык по средней линии. Глотание не нарушено, жевание не нарушено. Фонация удовлетворительная.
            <br><br>Рефлекторно-двигательная сфера: голову держит хорошо, из положения лежа поднимает. Сидит с кифозированной спиной. Самостоятельно садится. Походка миопатическая. Прыгает на двух ногах с затруднениями, бегает неловко. Эквиновальгусная деформация стоп. Контрактуры голеностопных суставов. Псевдогипертрофия икроножных мышц. Верхние конечности: движения в суставах не ограничены. Мышечный тонус гипотонический. Сила мышц снижена. Сухожильные рефлексы не вызываются, D=S. Нижние конечности: мышечный тонус гипотонический. Сила мышц снижена. Сухожильные рефлексы не вызываются, D=S. Чувствительность ориентировочно не нарушена. Координаторных нарушений нет. 6-минутный тест 382 м. </p>
        ...
        <hr class="dashed-line">
                    <div class="lab-tests">
                        ...
                        <div class="test-item">
                            ...
                            <div class="test-details">
                                <p class="text-block">                        
                                    Площадь поверхности тела 0,85 м2. Магистральные сосуды и предсердия: аорта 22,5 мм (N 19-25). Легочная артерия 22,1 мм. Левое предсердие 27,7 мм (N 17-29), V 23,4 мл, Vi 27,5. Правое предсердие V 20,1 мл, Vi 23,6. Левый желудочек: Тзслж = 5,2 мм (N 4-7), Тзслж = 26,1 мм (N 17-28), УО = 49,4 мл, ФВ = 60,0 мм (N>55 % - по Симпсону). Масса миокарда = 61,3 г. ИОТС = 0,27. Правый желудочек = 14,2 мм (N 5-15), TAPSE = 23,4 мм. Митральный клапан: створки тонкие. Поток 1,14 м/сек. Регургитация: нет. Аортальный клапан: трехстворчатый, створки тонкие. Поток 1,22 м/сек. Регургитация: нет. Трискуспидальный клапан: створки тонкие. Поток 1,22 м/сек. Регургитация: физиол. Клапан легочной артерии: створки тонкие. Поток 1,19 м/сек. Регургитация: физиол. МПП интактна. МЖП сокращается правильно. Дополнительные особенности: фальшхорды в полости ЛЖ. Поток в нисх. Ао - 1,33 м/сек. Заключение: ЭхоКГ признаков пороков сердца не выявлено. Умеренно выраженная тоногенная дилатация полости левого желудочка без признаков снижения глобальной сократительной способности миокарда. Диастолическая функция не нарушена. Клапаны интактны. Фальшхорды в полости левого желудочка.
                                </p>
    ...
    },
    {
        ...
        questionData: {
            ...
            correctDescription: "Пациентам с установленным диагнозом МДД/МДБ рекомендуется исследование кислотно-основного состояния и газов крови для оценки степени компенсации дыхательных нарушений и определения тактики респираторной поддержки <sup>1</sup>.",
            wrongDescription: {
                "wrong-answer-value": "Правильный ответ: Исследование кислотно-основного состояния и газов крови для оценки степени компенсации дыхательных нарушений и определения тактики респираторной поддержки.<br><br>Проведение молекулярно-генетического исследования в гене DMD рекомендуется всем пациентам с клиническими симптомами, характерными для МДД/МДБ, или пациентам без клинической симптоматики, но с повышенным не менее чем в 20 раз уровнем КФК  для подтверждения диагноза и проведения медико-генетического консультирования семьи<sup>1</sup>.",
    ...
    },
    {
        ...
        questionData: {
            ...
            answers: [
                { id: 1, text: "МРТ мышечной системы, рентгенография или КТ грудного и поясничного отдела позвоночника, ЭКГ и ЭхоКГ сердца, рентгеноденситометрия поясничного отдела позвоночника, спирометрия.", value: "correct-answer-value" },
                { id: 2, text: "ЭКГ и ЭхоКГ сердца, спирометрия.", value: "wrong-answer-value" },
            ...
            correctDescription: "Пациентам с установленным диагнозом ПМДД рекомендованы следующие инструментальные обследования<sup>1</sup>:<br><br>• МРТ мышечной системы (МРТ целевых мышц) с целью оценки степени поражения мышечной ткани.<br>• Рентгенография или КТ грудного и поясничного отдела позвоночника с целью оценки степени сколиоза, а также определения возможности и степени хирургического вмешательства.<br>• ЭКГ и ЭхоКГ сердца с целью выявления специфического поражения сердца.<br>• Спирометрия для оценки функционального состояния легких.<br>• Рентгеноденситометрия поясничного отдела позвоночника для исключения остеопороза.",
            wrongDescription: {
                "wrong-answer-value": "Правильный ответ: МРТ мышечной системы, рентгенография или КТ грудного и поясничного отдела позвоночника, ЭКГ и ЭхоКГ сердца, рентгеноденситометрия поясничного отдела позвоночника, спирометрия.<br><br>Эти обследования рекомендованы всем пациентам с диагнозом ПМДД<sup>1</sup>."
            },
            additionalInfo: {
                "wrong-answer-value": `
                    1. Клинические рекомендации. Прогрессирующая мышечная дистрофия Дюшенна. Прогрессирующая мышечная дистрофия Беккера. 2023 год.
    ...
    },
    {
        ...
        <p class="text-block_diagnosis">I42.9 — Кардиопатия неуточненная у ребенка с ПМД Дюшенна(умеренная дилятация полости ЛЖ).</p>
        ...
        <div class="patient-child">
            ...
            <button id="nextButtonChild">Далее</button>
                    ...
                    },
                    {
                        ...
                        <footer>
    <h1 class="footer-info">ИНФОРМАЦИЯ ПРЕДНАЗНАЧЕНА ДЛЯ МЕДИЦИНСКИХ РАБОТНИКОВ</h1>
    <div class="footer-box">
    <div class="footer-left">
        АО «Рош-Москва» <br>
        107031, Россия, г. Москва, Трубная площадь, дом 2, помещение 1, <br>
        этаж 1, комната 42, МФК «Галерея Неглинная»<br>
